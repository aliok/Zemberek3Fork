...
public class TurkceEkAdlari {
    ...
    public static final String Ness = "Ness";
    public static final String Quite = "Quite";
    public static final String Resemblance = "Resemblance";
    public static final String Resemblance2 = "Resemblance2";
    ...
    public static final String MadeFor = "MadeFor";
    public static final String Inst = "Inst";
    public static final String P1sg = "P1sg";
    public static final String P2sg = "P2sg";
    public static final String P3sg = "P3sg";
    public static final String P1pl = "P1pl";
    public static final String P2pl = "P2pl";
    ...
    public static final String A1pl = "A1pl";
    public static final String A2pl = "A2pl";
    public static final String A3pl = "A3pl";
    ...
    public static final String WithoutDoing = "WithoutDoing";
    ...
    public static final String PastPart = "PastPart";
    ...
    public static final String Hastily = "Hastily";
    public static final String Almost = "Almost";
    public static final String Abil = "Abil";
    public static final String Necess = "Necess";
